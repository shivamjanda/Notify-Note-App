...
const NoteCard = ({note}) => {
    // gets the note body and breaks each characters by spaces and convert it into an array.
    // Get the first 20 words and join the words back to a string with spaces in between
    // Want to display the first 20 words of the note
    const body = `${note.body.split(" ").slice(0, 20).join(" ")} ...`
  // Different color for each catergory
